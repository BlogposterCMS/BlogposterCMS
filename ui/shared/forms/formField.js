 ...
 */
export function createFormField(labelText, control, options = {}) {
...
export function createFormChoice(labelText, control) {
    const label = document.createElement('label');
...
export function createFormSwitch(labelText, control) {
