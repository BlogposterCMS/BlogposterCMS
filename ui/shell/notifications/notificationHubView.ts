import type { NotificationSummary } from './notificationHubData.js';

const PRIORITIES: Record<string, { label: string; icon: string }> = {
...
export function renderNotificationItems(list: HTMLUListElement, items: NotificationSummary[]): void {
