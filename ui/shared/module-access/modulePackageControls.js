import { inspectModuleZip, installModuleZip } from './modulesListData.js';
export function dialogApi() {
    return window.bpDialog || null;
}
export function accessEventLabel(access) {
...
export async function reviewModuleAccess(title, message, inspection, confirmLabel, defaultApproved = true) {
...
export async function installModuleArchive(zipData, fileName, status) {
