...
export class PixelGrid {
    ...
    _determineNextPosition(activeWidget, activeRect, other, otherRect) {
        ...
        const addCandidate = (x, y, axis, direction) => {
            if (!this._fitsWithin(x, y, otherRect.w, otherRect.h))
                return;
        ...
        if (collisionFree)
            return { x: collisionFree.x, y: collisionFree.y };
        if (sorted.length)
    ...
    _updateBBox() {
        ...
        if (typeof manager.setDisabled === 'function')
