...
export function initAdminSearch(): void {
  ...
  const searchContainer = container as HTMLElement;
  ...
  searchInput.addEventListener('focus', () => {
    if (!disabled) setSearchExpanded(searchContainer, searchInput, true);
  });
