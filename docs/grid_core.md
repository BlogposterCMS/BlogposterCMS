...
- `bbox/BoundingBoxManager.js`: minimal bounding box renderer without mode logic. Provides `setDisabled(flag)` to toggle interaction and mirror the shared grid interface.
