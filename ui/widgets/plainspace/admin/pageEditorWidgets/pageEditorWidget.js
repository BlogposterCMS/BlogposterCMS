import { asString, clearPageEditorCache, errorMessage, fetchPageEditorTemplates, savePageEditorPage, toPage } from './pageEditorData.js';
export async function render(el) {
    ...
    templates.forEach(template => {
        ...
        o.value = name;
        o.textContent = name;
        if ((page.meta?.layoutTemplate || '') === name)
            o.selected = true;
    ...
    window.saveCurrentPage = async function saveCurrentPage() {
        try {
