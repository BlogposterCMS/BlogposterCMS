...
jest.mock('../ui/designer/app/utils.js', () => ({
  executeJs: jest.fn(),
}));

jest.mock('../ui/designer/app/renderer/layoutRender.js', () => ({
  renderLayoutTree: jest.fn(),
}));

const { renderPage, canExecuteCustomJs } = require('../ui/designer/app/runtime/pageLoader.js');
const { executeJs } = require('../ui/designer/app/utils.js');
const { renderLayoutTree } = require('../ui/designer/app/renderer/layoutRender.js');
const { sanitizeHtml } = require('../ui/shared/sanitize/sanitizer.js');
