...
type DesignerBootstrapWindow = Window & {
  CSRF_TOKEN?: string | null;
  ADMIN_TOKEN?: string | null;
  __BLOGPOSTER_APP_INIT_TOKENS__?: InitTokensMessage;
};

const bootstrapWindow = window as DesignerBootstrapWindow;
...
function applyInitTokens(msg: InitTokensMessage, eventOrigin: string | null): boolean {
...
function maybeApplyCachedInitTokens(): void {
  const cached = bootstrapWindow.__BLOGPOSTER_APP_INIT_TOKENS__;
  if (!cached || cached.type !== 'init-tokens') return;
