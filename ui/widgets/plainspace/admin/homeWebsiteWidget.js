...
export async function render(el) {
    ...
    const continueLink = root.querySelector('[data-continue]');
    // Studio has its own server entry, outside the admin page router.
    for (const link of [preview, continueLink]) {
        link.target = '_blank';
        link.rel = 'noopener';
    }
    continueLink.href = `${base}/content/designer-layouts`;
    preview.href = continueLink.href;
    root.querySelector('[data-new]').href = `${base}/content/pages`;
    root.querySelector('[data-pages]').href = `${base}/content/pages`;
    root.querySelector('[data-drafts]').href = `${base}/content/pages`;
    root.querySelector('[data-media]').href = `${base}/content/media`;
