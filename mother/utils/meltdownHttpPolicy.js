...
const HTTP_LEGACY_ADMIN_EVENT_FACADE_ACTIONS = Object.freeze({
  ...
  getUserAccess: { resource: 'users', action: 'access' },
  setUserAccess: { resource: 'users', action: 'setAccess' },
  ...
  inspectModuleZipAccess: { resource: 'modules', action: 'inspectZip' },
  installModuleFromZip: { resource: 'modules', action: 'installZip' },
  listPendingModuleAccessRequests: { resource: 'modules', action: 'accessRequests' },
  resolveModuleAccessRequest: { resource: 'modules', action: 'resolveAccessRequest' },
