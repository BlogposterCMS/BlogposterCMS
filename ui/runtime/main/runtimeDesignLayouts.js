import { normalizeEffects, parseMetadata } from './sceneRuntime.js';
...
export function normalizeRuntimeDesignWidget(widget = {}) {
...
export function getRuntimeDesignLayout(response) {
...
export function applyRuntimeDesignStyles(target, design) {
    if (!target || !design || typeof design !== 'object')
        return;
    const source = design;
    if (source.bg_color) {
