const featherIcons: Record<string, string> = {
...
window.featherIcon = function featherIcon(name: string, extraClass = ''): string {
  const src = featherIcons[name] || `/assets/icons/${name}.svg`;
